  ...
  return (
    <header className="sticky top-0 bg-white shadow-md z-50">
      <div className="container mx-auto flex flex-col sm:flex-row items-center justify-between p-4">
        ...
        <h1 className="text-xl text-black font-bold mb-4 sm:mb-0 sm:absolute sm:left-1/2 sm:transform sm:-translate-x-1/2">
...
>
  <motion.a
    ...
    variants={item}
  >
    <FaLinkedinIn className="text-xl cursor-pointer text-black hover:text-blue-600" />
  </motion.a>
  <motion.a
    ...
    variants={item}
  >
    <FaSquareGithub className="text-xl cursor-pointer text-black hover:text-gray-600" />
  </motion.a>
  <motion.a
    ...
    variants={item}
  >
    <FaXTwitter className="text-xl cursor-pointer text-black hover:text-black" />
  </motion.a>
  <motion.a
    ...
    variants={item}
  >
    <BsInstagram className="text-xl cursor-pointer text-black hover:text-pink-600" />
  </motion.a>
</motion.div>
...
>
  ...
  <motion.a
    ...
    variants={item}
  >
    <FaEnvelope className="text-xl cursor-pointer text-black hover:text-red-600" />
  </motion.a>
</motion.div>
      </div>
    </header>
